...
object PrimitiveMultipleValueField {
  def apply(typeName: String, value: List[String]): PrimitiveMultipleValueField = PrimitiveMultipleValueField(TYPE_CLASS_PRIMITIVE, typeName, multiple = true, value)
}
